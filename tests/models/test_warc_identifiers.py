...
class TestWarcIdentifiers(unittest.TestCase):
    ...
    def test_payload_digest(self):
        ...
        self.assertEqual(str(digest), 'sha1:2fd4e1c67a2d28fced849ee1bb76e7391b93eb12')
        self.assertEqual(digest, 'sha1:2fd4e1c67a2d28fced849ee1bb76e7391b93eb12')
        
        # Test equality
        other_digest = PayloadDigest('sha1:2fd4e1c67a2d28fced849ee1bb76e7391b93eb12')
